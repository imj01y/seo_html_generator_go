...
func DefaultCachePoolConfig() *CachePoolConfig {
	return &CachePoolConfig{
		ID:                           1,
		TitlePoolSize:                100000,
		TitleWorkers:                 4,
		TitleRefillIntervalMs:        200,
		TitleThreshold:               0.3,
		...
		ClsPoolSize:                  100000,
		ClsWorkers:                   4,
		ClsRefillIntervalMs:          200,
		ClsThreshold:                 0.3,
		UrlPoolSize:                  100000,
		UrlWorkers:                   4,
		UrlRefillIntervalMs:          200,
		UrlThreshold:                 0.3,
		KeywordEmojiPoolSize:         50000,
		KeywordEmojiWorkers:          2,
		KeywordEmojiRefillIntervalMs: 200,
		KeywordEmojiThreshold:        0.3,
	}
}
